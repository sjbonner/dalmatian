...
## pfresults4$summary <- summary(pfmcmc4)
...
## pfresults4$caterpillar <- caterpillar(pfmcmc4,show = FALSE)

## Fixed effects for mean
pfresults4$caterpillar$meanFixed

## Fixed effects for dispersion
pfresults4$caterpillar$dispersionFixed
```

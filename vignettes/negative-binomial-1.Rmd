...
vignette: >
  %\VignetteIndexEntry{Negative Binomial Example 1}
...
nbconvergence <- convergence(nbresults)
...
## Generate traceplots
nbtraceplots <- traceplots(nbresults,show=FALSE)
...
nbcaterpillar <- caterpillar(nbresults,show = FALSE)

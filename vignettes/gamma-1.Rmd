...
if(!runModels){
  load(system.file("Gamma_1","gresults.RData",package="dalmatian"))
}
```
...
gconvergence <- convergence(gresults)
...
## Generate traceplots
gtraceplots <- traceplots(gresults,show=FALSE)
...
gcaterpillar <- caterpillar(gresults,show = FALSE)

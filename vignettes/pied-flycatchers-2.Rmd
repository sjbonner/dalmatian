...
## pfresults3$summary <- summary(pfmcmc3)
...
## pfresults3$ranef <- ranef(pfresults3)
...
ggplot(data=as.data.frame(pfresults3$ranef$mean[nind+(1:nind),]),aes(x=1:nind,y=Mean)) + 
  geom_point() + 
